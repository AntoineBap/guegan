      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.infoContainer}>
          ...
          <View style={styles.clientBlock}>
            ...
            <Text>
              {order.shippingAddress?.zipCode || order.billingAddress?.zipCode}{" "}
        ...
        <Text style={styles.docTitle}>
          Bon de livraison N° {order.orderNumber}
        </Text>
        <Text style={{ marginBottom: 5 }}>Date : {today}</Text>

        <Text style={styles.introText}>
          Madame, Monsieur,{"\n\n"}
          Nous vous remercions de votre confiance. En accord avec votre
          commande, veuillez trouver les articles suivants :
        </Text>
              ...
              <View style={styles.tableColDesc}>
                <Text style={styles.tableCell}>
                  ...
                  item.sinks[0]?.type !== "Aucune cuve"
                    ? `+ ${item.sinks.length} découpe(s) cuve`
                    : ""}
                </Text>
              </View>
