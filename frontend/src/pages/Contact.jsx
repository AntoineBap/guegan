...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                setStatus('success');
                setFormData({ nom: '', prenom: '', email: '', phone: '', objet: '', message: '', consent: false });
                setAttachment(null);
            } else {
                setStatus('error');
            }
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="checkbox-group">
                            <label>
                                ...
                                />
                                J’accepte le traitement de mes données personnelles pour le suivi de ma demande.
                            </label>
                        </div>
                ...
                <div className="contact-info-section">
                    <div className="info-box">
                        ...
                        <div className="info-item">
                            ...
                            <p>1 rue de l’industrie,<br/>93000 Bobigny</p>
                        </div>
                        <div className="info-item">
                            <span className="icon">📞</span>
                            <p>01.48.40.05.05</p>
