...
const OrderConfirmation = () => {
    ...
    if (!order) return <div style={{padding:'50px', textAlign:'center'}}>Chargement de la commande...</div>;
        ...
        <div className="confirmation-page">
            ...
            <div className="order-grid">
                ...
                <div className="card info-card">
                    ...
                    <p><strong>Statut :</strong> <span className="status-badge pending">En attente de paiement</span></p>
                    <p style={{color: '#e74c3c', marginTop: '10px'}}>
                        <strong>📅 Date limite de paiement :</strong> {formatDate(order.paymentDeadline)}
                    </p>
                </div>
                ...
                <div className="card bank-card">
                    ...
                    <p>Veuillez effectuer le virement avant la date limite vers le compte suivant :</p>
                    <div className="iban-box">
                        <p><strong>Banque :</strong> GUEGAN PRO BANK</p>
                        <p><strong>IBAN :</strong> FR76 1234 5678 9012 3456 7890 123</p>
                        <p><strong>BIC :</strong> GUEGFR2P</p>
                        <p><strong>Libellé du virement :</strong> {order._id}</p>
                    </div>
                    <small>La fabrication de votre commande sur-mesure débutera dès réception du paiement.</small>
                </div>
                        ...
                        <tbody>
                            {order.items.map((item, idx) => (
                                <tr key={idx}>
                                    ...
                                    <td>{item.length}x{item.width}mm, {item.sinks.length} cuve(s)</td>
                                    <td>{item.quantity}</td>
